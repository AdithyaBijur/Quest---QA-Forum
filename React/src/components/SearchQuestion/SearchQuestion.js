...
class SearchQuestion extends Component {
    ...
    componentDidMount() {
        ...
        this.Auth.fetch(backEnd + 'viewqa', {
    ...
    ansSubmit = () => {
        const q = this.props.match.params
        this.Auth.fetch(backEnd + 'addanswer', {
            method: 'POST', body: JSON.stringify({
    ...
    upans = (aid) => {
        this.Auth.fetch(backEnd + 'editupvotes', {
            method: 'POST', body: JSON.stringify({
    ...
    downans = (aid) => {
        this.Auth.fetch(backEnd + 'editdownvotes', {
            method: 'POST', body: JSON.stringify({
    ...
    upques = (aid) => {
        const q = this.props.match.params
        this.Auth.fetch(backEnd + 'editupvotesquestion', {
            method: 'POST', body: JSON.stringify({
    ...
    downques = (aid) => {
        const q = this.props.match.params
        this.Auth.fetch(backEnd + 'editdownvotesquestion', {
            method: 'POST', body: JSON.stringify({
                        ...
                        <div className="QT">
                            <div className="questinfo">
                                <div className="qasecdiv">
                                    ...
                                    <div className="as"><p>Asked by:</p><a href="">{this.state.question.creatorname}</a></div>
                                </div>
                            </div>
